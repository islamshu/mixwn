			...
			<form class="form form-horizontal mar-top" action="{{route('digitalproducts.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="form-group row">
                            <label class="col-md-2 col-from-label">{{translate('Url for Dawnload')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <textarea name="url" class="form-control" id="" cols="10" rows="5" required>{{ $product->url }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-from-label">{{translate('Password')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" value="{{ $product->password }}" name="password" placeholder="{{translate('Password')}}" required>
                            </div>
                        </div>
