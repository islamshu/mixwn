                ...
                <div class="row aiz-steps arrow-divider">
                    ...
                    <div class="col done">
                        <div class="text-center text-success">
                            ...
                            <h3 class="fs-14 fw-600 d-none d-lg-block text-capitalize" style="color: black !important">{{ translate('2. Shipping info')}}</h3>
                    ...
                    <div class="col done">
                        <div class="text-center text-success">
                            ...
                            <h3 class="fs-14 fw-600 d-none d-lg-block text-capitalize"  style="color: black !important">{{ translate('3. Delivery info')}}</h3>
                       
                        </div>
                    </div>
                    <div class="col active">
                        <div class="text-center text-primary">
                            <i class="la-3x mb-2 las la-credit-card" style="color: rgb(0, 0, 0) !important"></i>
                            <h3 class="fs-14 fw-600 d-none d-lg-block text-capitalize" style="color: rgb(0, 0, 0) !important">{{ translate('4. Payment')}}</h3>
                        </div>
                    </div>
                    <div class="col">
